...
const controller1 = Renderer.threeRenderer.xr.getController( 0 );
const controller2 = Renderer.threeRenderer.xr.getController( 1 );
...
controllers[ 1 ].addEventListener( 'selectend', ()=> {} );
